...
if __name__ == "__main__":
    ...
    args.add_argument('--accelerator', type = str, default = 'auto')
    ...
    train_dataset = DigiFaceDataset(hparams.dataset.joinpath("train"), pre_transforms = transforms, image_size = (384, 384))
    val_dataset = DigiFaceDataset(hparams.dataset.joinpath("val"), pre_transforms = transforms, image_size = (384, 384))
